...
Constructed network using {\bf Mininet} with multiple {\bf TRex Traffic Generator} at hosts establishing {\bf TCP} communication and obtaining telemetry.\\
Constructed {\bf \href{https://github.com/bidhovbizar/DCN-Simulation/tree/master/PythonCode}{Simulation Framework}} in {\bf Python} for large scale Data Center.  \\ 
